...
public class RoundImageCircleView extends AppCompatImageView {
    //圆角大小，默认为10
    ...
    public RoundImageCircleView(Context context) {
        this(context, null);
    }

    public RoundImageCircleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundImageCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
