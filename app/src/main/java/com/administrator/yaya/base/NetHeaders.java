...
//        headers.put("Authorization", Application10.getApplication().mToken);
        headers.put("UUID", BaseApp.getInstance().mUuid.toString());
        headers.put("device_id",BaseApp.getInstance().mUuid.toString());
...
//        header.put("sign", sign);
    ...
    public static String getUserAgent() {
        ...
        String s = WebSettings.getDefaultUserAgent(BaseApp.getApplication()) + " News/" + versionCode + " Android/"
    ...
    public static String getVersionName() {
        try {
            PackageManager manager = BaseApp.getApplication().getPackageManager();
