...
//推广排行适配器
public class TuiguangRankingAdapter extends RecyclerView.Adapter<TuiguangRankingAdapter.Vh> {
    ...
    public TuiguangRankingAdapter(ArrayList<TestTodayRanking.DataBean.ListBean> list) {
        this.list = list;
    }
    @NonNull
    @Override
...
//        ucount  成交单数
        ...
        vh.mChengjiaoDan.setText("推广成交" + ucount + "单");
