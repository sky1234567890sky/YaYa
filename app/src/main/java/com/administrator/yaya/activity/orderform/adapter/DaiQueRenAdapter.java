...
public class DaiQueRenAdapter extends RecyclerView.Adapter<DaiQueRenAdapter.Vh> {
    ...
    public void onBindViewHolder(@NonNull Vh vh, final int i) {
        ...
        if (orderPayTpe == 0){
            vh.daiqurenGcomName.setVisibility(View.GONE);
        }else if (orderPayTpe==1){
            vh.daiqurenGcomName.setText("【微信】订单编号：" + orderSalesListBean.getOrderNumber());
        }else if (orderPayTpe==2){
            vh.daiqurenGcomName.setText("【支付宝】订单编号：" + orderSalesListBean.getOrderNumber());
        }
        ...
        vh.daiqurenCommodityPrice.setText("售卖总价￥:"+orderSalesListBean.getCommodityPrice());
